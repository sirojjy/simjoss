            ...
            <div class="container-fluid">
                <div class="row clearfix">
                    <div class="col-xl-11 mx-auto">
                        <h5 class="mb-10 text-uppercase"><b>Dana Equity</b></h5>
                        <hr/>
                            ...
                            <div class="card-body">
                                ...
                                <div class="border p-4 rounded">
                                    <div class="card-title d-flex align-items-center">
                                        ...
                                        <h5 class="mb-0 text-primary "> <b>Tambah Data Dana Equity</b></h5>
                                    </div>
                                    <hr/>
                                    <div class="row mb-3">
                                    ...
                                    <!-- <div class="row mb-3">
                                        <label for="inputPhoneNo2" class="col-sm-3 col-form-label">Total Setoran Modal</label>
                                        <div class="col-sm-4">
                                            <input type="text" required="" name="modal_pmn" class="form-control" placeholder="PMN">
                                        </div>
                                        <div class="col-sm-4">
                                            <input type="text" required="" name="modal_non" class="form-control" placeholder="Non PMN">
                                        </div>
                                    </div> -->
                                    <div class="row mb-3">
                                        <label for="inputPhoneNo2" class="col-sm-3 col-form-label">Total Setoran Sudah Terpakai</label>
                                        <div class="col-sm-4">
                                            <input type="text" required="" name="terpakai_pmn" class="form-control" placeholder="PMN">
                                        </div>
                                        <div class="col-sm-4">
                                            <input type="text" required="" name="terpakai_non" class="form-control" placeholder="Non PMN">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <a href="<?php echo site_url('Keuangan/ekuiti') ?>"><button type="button" class="btn btn-danger px-4">Batal</button></a>
                                        </div>
                                    </div>
                                    <br><br>
                                </div>
