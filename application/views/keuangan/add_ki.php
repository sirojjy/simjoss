            ...
            <div class="container-fluid">
                <div class="row clearfix">
                    <div class="col-xl-11 mx-auto">
                        <h5 class="mb-10 text-uppercase"><b>Kredit Investasi</b></h5>
                        <hr/>
                            ...
                            <div class="card-body">
                                ...
                                <div class="border p-4 rounded">
                                    <div class="card-title d-flex align-items-center">
                                        ...
                                        <h5 class="mb-0 text-primary "> <b>Tambah Data KI</b></h5>
                                    </div>
                                    <hr/>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputPhoneNo2" class="col-sm-3 col-form-label">Penarikan Kredit Investasi Pokok</label>
                                        <!-- <div class="col-sm-4">
                                            <input type="text" required="" name="ki_pokok_plafon" class="form-control" placeholder="Plafond">
                                        </div> -->
                                        <div class="col-sm-9">
                                            <input type="text" required="" name="ki_pokok_penarikan" class="form-control" >
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="inputPhoneNo2" class="col-sm-3 col-form-label">Penarikan Kredit Investasi IDC</label>
                                        <!-- <div class="col-sm-4">
                                            <input type="text" required="" name="ki_idc_plafon" class="form-control" placeholder="Plafond">
                                        </div> -->
                                        <div class="col-sm-9">
                                            <input type="text" required="" name="ki_idc_penarikan" class="form-control" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <a href="<?php echo site_url('Keuangan/kredit_investasi') ?>"><button type="button" class="btn btn-danger px-4">Batal</button></a>
                                        </div>
                                    </div>
                                    <br><br>
                                </div>
