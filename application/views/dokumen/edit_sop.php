                                ...
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-2" style="text-align: center;">
                                            <input class="form-check-input" type="radio" name="iso_9001" id="iso_9001" value="1" <?php if ($iso_9001 == '1') { echo 'checked'; }?>>
                                            <label class="form-check-label" for="flexRadioDefault1">
                                                Ya
                                            </label>
                                        </div>
                                        <div class="col-sm-2" >
                                            <input class="form-check-input" type="radio" name="iso_9001" id="iso_9001" value="0" <?php if ($iso_9001 == '0') { echo 'checked'; }?>>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-2" style="text-align: center;">
                                            <input class="form-check-input" type="radio" name="iso_14001" id="iso_14001" value="1" <?php if ($iso_14001 == '1') { echo 'checked'; }?>>
                                            <label class="form-check-label" for="flexRadioDefault1">
                                                Ya
                                            </label>
                                        </div>
                                        <div class="col-sm-2" >
                                            <input class="form-check-input" type="radio" name="iso_14001" id="iso_14001" value="0" <?php if ($iso_14001 == '0') { echo 'checked'; }?>>
                                            <label class="form-check-label" for="flexRadioDefault2">
                                                Tidak
                                            </label>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-2" style="text-align: center;">
                                            <input class="form-check-input" type="radio" name="iso_45001" id="iso_45001" value="1" <?php if ($iso_45001 == '1') { echo 'checked'; }?>>
                                            <label class="form-check-label" for="flexRadioDefault1">
                                                Ya
                                            </label>
                                        </div>
                                        <div class="col-sm-2" >
                                            <input class="form-check-input" type="radio" name="iso_45001" id="iso_45001" value="0" <?php if ($iso_45001 == '0') { echo 'checked'; }?>>
                                            <label class="form-check-label" for="flexRadioDefault2">
                                                Tidak
                                            </label>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-2" style="text-align: center;">
                                            <input class="form-check-input" type="radio" name="iso_37001" id="iso_37001" value="1" <?php if ($iso_37001 == '1') { echo 'checked'; }?>>
                                            <label class="form-check-label" for="flexRadioDefault1">
                                                Ya
                                            </label>
                                        </div>
                                        <div class="col-sm-2" >
                                            <input class="form-check-input" type="radio" name="iso_37001" id="iso_37001" value="0" <?php if ($iso_37001 == '0') { echo 'checked'; }?>>
                                            <label class="form-check-label" for="flexRadioDefault2">
                                                Tidak
                                            </label>
                                        </div>
