            ...
            <div class="container-fluid">
                <div class="row clearfix">
                    <div class="col-xl-11 mx-auto">
                        <h5 class="mb-10 text-uppercase"><b>Dokumen Akta</b></h5>
                        <hr/>
                            ...
                            <div class="card-body">
                                ...
                                <div class="border p-4 rounded">
                                    <div class="card-title d-flex align-items-center">
                                        ...
                                        <h5 class="mb-0 text-primary "> <b>Edit Data Akta</b></h5>
                                    </div>
                                    <hr/>
                                    <input type="hidden"  value="<?php echo $id_dokumen ?>" name="id_dokumen" class="form-control">
                                    <div class="row mb-3">
                                        <label for="inputEmailAddress2" class="col-sm-3 col-form-label">Nama Akta</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="browse-wrap">
                                                <a href="<?php echo base_url("file_uploads/dokumen/akta/$file")?>" target="_blank" class="btn btn-success btn-sm " >&emsp;<i class="fa fa-print"></i>&nbsp; Preview &emsp;</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
