            ...
            <div class="container-fluid">
                <div class="row clearfix">
                    <div class="col-xl-11 mx-auto">
                        <h5 class="mb-10 text-uppercase"><b>Dokumen RKAP</b></h5>
                        <hr/>
                            ...
                            <div class="card-body">
                                ...
                                <div class="border p-4 rounded">
                                    <div class="card-title d-flex align-items-center">
                                        ...
                                        <h5 class="mb-0 text-primary "> <b>Edit Data RKAP</b></h5>
                                    </div>
                                    <hr/>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="browse-wrap">
                                                <a href="<?php echo base_url("file_uploads/dokumen/rkap/$file")?>" target="_blank" class="btn btn-success btn-sm " >&emsp;<i class="fa fa-print"></i>&nbsp; Preview &emsp;</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <a href="<?php echo site_url('Dokumen/rkap') ?>"><button type="button" class="btn btn-danger px-4">Batal</button></a>
                                        </div>
                                    </div>
                                    <br><br>
                                </div>
