            ...
            <div class="card">
                <div class="card-body border-bottom d-flex justify-content-between align-items-center">
                    ...
                    <?php if ($this->session->userdata('level_user') == 1) { ?>
                        <a href="<?php echo site_url('Dokumen/add_korporasi') ?>"><button type="button" class="btn btn-default"><i class="fa fa-plus"></i>&nbsp; Tambah Data</button></a>
                    <?php } ?>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="dt_korporasi" class="table table-bordered table-striped table-hover js-basic-example dataTable w-100">
                            <thead>
                                <tr class="text-center bg-info text-white">
                                    ...
                                    <th class="align-middle font-weight-bold">Keterangan</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        getDatatables({
            id: "#dt_korporasi",
            url: "<?= base_url('Dokumen/getKorporasi'); ?>",
            columnDefs: [{
                    targets: 0,
                    width: "1%",
                    className: "dt-nowrap",
