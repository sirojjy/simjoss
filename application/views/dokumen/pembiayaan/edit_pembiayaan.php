            ...
            <div class="card border-top border-0 border-4 border-primary">
                ...
                <form action="<?php echo $action ?>" enctype="multipart/form-data" data-parsley-validate="true" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <div class="browse-wrap">
                                    <a href="<?= base_url("file_uploads/dokumen/pembiayaan/" . $data->file) ?>" target="_blank" class="btn btn-success btn-sm "><i class="fa fa-print mr-2"></i>Preview</a>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                    ...
                    <div class="card-body d-flex justify-content-end">
                        ...
                        <a href="<?php echo site_url('Dokumen/pembiayaan') ?>"><button type="button" class="btn btn-danger px-4">Batal</button></a>
                    </div>
                </form>
            </div>
        </div>
