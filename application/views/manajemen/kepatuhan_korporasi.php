        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body border-bottom">
                    <div class="row">
                        <div class="col-lg-12">
                            <h4 class="card-title"><strong>Daftar Kewajiban Kepatuhan (Compliance Obligation List) <font color="red"> Aspek Korporasi</font></strong></h4>
                        </div>

                    </div>
                    <br>    
                    <?php if($this->session->userdata('level_user')==1) { ?>
                        <p align="right"><a href="<?php echo site_url('Manajemen/add_kepatuhan/korporasi') ?>"><button type="button" class="btn btn-default"><i class="fa fa-plus"></i>&nbsp; Tambah Data</button></a></p>
                    <?php } ?>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('Manajemen/edit_kepatuhan/korporasi/' . $rw->id_kewajiban_kepatuhan) ?>"   class="badge badge-success" title="Edit"><i class="fa fa-edit"></i></a>
                                            <a href="<?php echo site_url('Manajemen/hapus_kepatuhan_kor/' . $rw->id_kewajiban_kepatuhan) ?>"  title="hapus" class="badge badge-danger btn-sm" onClick="javasciprt: return confirm('Yakin menghapus data ?')" ><i class="fa fa-trash"></i></a>
