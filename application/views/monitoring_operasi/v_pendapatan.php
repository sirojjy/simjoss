        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body border-bottom d-flex justify-content-between align-items-center">
                    <h4 class="mb-0 font-bold">Data Perbandingan Pendapatan Tol</h4>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="dt_pendapatan" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            <thead>
...
<div class="modal fade" id="modalAdd" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style="max-width: 700px">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo site_url('Monitoring_operasi/insert_pendapatan') ?>" method="POST">
...
<div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style="max-width: 700px">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo site_url('Monitoring_operasi/update_pendapatan') ?>" method="POST">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group form-group-default">
                                <label for="edit_nilai">Pendapatan</label>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#dt_pendapatan').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url('monitoring_operasi/get_pendapatan') ?>",
                "type": "GET"
            },
            "columns": [{
                    "data": "id"
