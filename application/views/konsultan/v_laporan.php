                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body border-bottom">
                                ...
                                <p align="right"><a href="<?php echo site_url('Kontrak_konsultan/'.$aksi.'/'.$id_kontrak) ?>"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Tambah Data</button></a></p>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                             <tr align="center">
                                                ...
                                                <td>
                                                    <a href="<?php echo site_url('Kontrak_konsultan/'.$edit.'/' . $dt->id_laporan.'/'.$dt->id_kontrak_konsultan) ?>"  title="edit" class="btn btn-success btn-sm" ><i class="fa fa-edit"></i></a>
                                                    <a href="<?php echo site_url('Kontrak_konsultan/'.$hapus.'/' . $dt->id_laporan.'/'.$dt->id_kontrak_konsultan) ?>"  title="hapus" class="btn btn-danger btn-sm" onClick="javasciprt: return confirm('Yakin menghapus data ?')" >Hapus</a>
                                                </td>
                                             </tr>
                                            <?php } ?>
