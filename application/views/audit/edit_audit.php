                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control show-tick ms select2" name="kategori">
                                        ...
                                        <option <?php if ($kategori == 3) {
                                                    echo 'selected';
                                                } ?> value="3">Mayor</option>
                                        <option <?php if ($kategori == 2) {
                                                    echo 'selected';
                                                } ?> value="2">Minor</option>
                                        <option <?php if ($kategori == 1) {
                                                    echo 'selected';
                                                } ?> value="1">Observasi</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control show-tick ms select2" name="iso">
                                        ...
                                        <option <?php if ($iso == '9001') {
                                                    echo 'selected';
                                                } ?> value="9001">9001:2015</option>
                                        <option <?php if ($iso == '14001') {
                                                    echo 'selected';
                                                } ?> value="14001">14001:2015</option>
                                        <option <?php if ($iso == '45001') {
                                                    echo 'selected';
                                                } ?> value="45001">45001:2018</option>
                                        <option <?php if ($iso == '37001') {
                                                    echo 'selected';
                                                } ?> value="37001">37001:2016</option>
                                    </select>
                                </div>
                            </div>
