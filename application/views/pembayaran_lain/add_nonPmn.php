                            ...
                            <div class="card-body">
                                ...
                                <div class="border p-4 rounded">
                                    <div class="card-title d-flex align-items-center">
                                        ...
                                        <h5 class="mb-0 text-primary "> <b>Tambah Data Dokumen Pembayaran Non PMN</b></h5>
                                    </div>
                                    <hr/>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputPhoneNo2" class="col-sm-3 col-form-label">Keterangan Transaksi</label>
                                        <div class="col-sm-9">
