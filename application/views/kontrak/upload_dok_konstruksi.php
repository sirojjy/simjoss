                            ...
                            <div class="table-responsive">
                                <table id="table2" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        $dok_lain = $this->db->query('select * from detail_dok_konstruksi where id_kontrak_konstruksi=' . $id_kontrak . ' and id_dok_master=100 order by tanggal_dok DESC')->result();

                                        foreach ($dok_lain as $dt) {
                                            $detail_dok = $this->db->query('select * from detail_dok_konstruksi where id_kontrak_konstruksi=' . $id_kontrak . ' and id_dok_master=100')->row_array();
...
<div class="modal fade" id="addDokumenLain" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style="max-width: 700px">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo site_url('Kontrak/act_Upload_dokLain') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                            <div class="form-group form-group-default">
                                ...
                                <div class="browse-wrap">
                                    <input type="file" name="file" class="btn btn-secondary btn-block" title="Choose a file to upload" required="">
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="updateDokLain" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style="max-width: 700px">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo site_url('Kontrak/act_Update_dokLain') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                <div class="modal-body" style="padding: 2.2rem">
...
<div class="modal fade" id="addRowModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style="max-width: 700px">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo site_url('Kontrak/act_Upload_dokKonstruksi') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                <div class="modal-body" style="padding: 2.2rem">
...
<div class="modal fade" id="updateDok" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style="max-width: 700px">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo site_url('Kontrak/act_Update_dokKonstruksi') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                <div class="modal-body" style="padding: 2.2rem">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-default">
                                ...
                                <select class="form-control show-tick ms select2" name="pic_update" id="pic">
                                    <option value="">-- Pilih --</option>
                                    <option value="Teknik">Teknik</option>
                                    <option value="Lahan">Lahan</option>
                                    <option value="Proyek">Proyek</option>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#updateDok').on('show.bs.modal', function(e) {
            ...
            var link = "<?= base_url() ?>";
            var evidence = '<a href="' + link + "file_uploads/kontrak_konstruksi/" + file + '" target="_blank" class="btn btn-success btn-sm btn-block"><i class="ti ti-printer"></i> Preview Dokumen</a>';
