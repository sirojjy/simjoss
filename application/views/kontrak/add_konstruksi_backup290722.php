                            ...
                            <div class="card-body">
                                ...
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" required="" name="pihak1" class="form-control" value="PT Trans Jawa Paspro Jalan Tol">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="card-title d-flex align-items-center">
                                        ...
                                        <h5 class="mb-0 text-primary "> <b>Checklist Dokumen yang Diperlukan</b></h5>
                                    </div>
                                    <hr/>
