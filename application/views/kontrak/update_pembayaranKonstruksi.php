                                ...
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-2 text-center">      
                                            ...
                                            <?php } else { ?>
                                                <a href="<?php echo base_url("file_uploads/kontrak_konstruksi/dokumen_pembayaran/".$bg[0]->dok_file)?>" target="_BLANK" class="btn btn-sm  btn-primary"><i class="fa fa-print"></i></a>
                                            <?php } ?>
                                        </div>
                                        <div class="col-sm-3 text-center">      
...
<div class="modal fade" id="addRowModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style="max-width: 700px">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo site_url('Kontrak/act_UploadPembayaran_edit') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
...
<div class="modal fade" id="updateDok" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style="max-width: 700px">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo site_url('Kontrak/act_dokPembayaran_edit') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                <div class="modal-body" style="padding: 2.2rem">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#updateDok').on('show.bs.modal', function(e) { 
                ...
                var link = "<?= base_url()?>";
                var evidence ='<a href="'+link+"file_uploads/kontrak_konstruksi/dokumen_pembayaran/"+file+'" target="_blank" class="btn btn-success btn-sm btn-block"><i class="ti ti-printer"></i> Preview Dokumen</a>';
