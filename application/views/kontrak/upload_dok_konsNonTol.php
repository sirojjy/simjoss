                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover ">
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    // $dok_kontrak = $this->db->query("select *from dok_master where id_dok_master in(10,11,12,13,14,15) order by id_dok_master ASC")->result();
                                ...
                                <tbody>
                                    ...
                                    foreach ($dok_lain as $dt) {
                                        ...
                                        if ($dt->nomor_dok == null) {
                                            ...
                                            $pic = $dt->pic;
                                            // $lokasi = $dt->kantor.'/Rak '.$dt->no_rak.' '.$dt->no_box;
                                            $lokasi = (empty($detail_dok['kantor']) ? '-' : $detail_dok['kantor']) . ' ' . (empty($detail_dok['no_rak']) ? '-' : $detail_dok['no_rak']) . ' ' . (empty($detail_dok['no_box']) ? '-' : $detail_dok['no_box']);
                                        }
                                    ?>
                                        <tr>
                                            <td align="center"><?php echo $no++ ?>.</td>
                                            ...
                                            <td align="center">
                                                ...
                                                <a href="<?php echo site_url('Kontrak/hapus_dokLain_konsNonTol/' . $id_kontrak . '/' . $dt->id_detail_dok) ?>" title="hapus" class="btn btn-danger btn-sm" onClick="javasciprt: return confirm('Yakin menghapus data ?')"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
...
<div class="modal fade" id="addDokumenLain" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style="max-width: 700px">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo site_url('Kontrak/act_Upload_dokLainNonTol') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-default">
                                ...
                                <input type="text" name="nomor_dok" required="" class="form-control">
                            </div>
                        </div>
...
<div class="modal fade" id="updateDokLain" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style="max-width: 700px">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo site_url('Kontrak/act_Update_dokLainNonTol') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                <div class="modal-body" style="padding: 2.2rem">
...
<div class="modal fade" id="addRowModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style="max-width: 700px">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo site_url('Kontrak/act_Upload_dokNonTol') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                <div class="modal-body" style="padding: 2.2rem">
...
<div class="modal fade" id="updateDok" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style="max-width: 700px">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo site_url('Kontrak/act_Update_dokNonTol') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                <div class="modal-body" style="padding: 2.2rem">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#updateDok').on('show.bs.modal', function(e) {
            ...
            var link = "<?= base_url() ?>";
            var evidence = '<a href="' + link + "file_uploads/konstruksi_nonTol/" + file + '" target="_blank" class="btn btn-success btn-sm btn-block"><i class="ti ti-printer"></i> Preview Dokumen</a>';
