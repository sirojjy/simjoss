                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body border-bottom">
                                <h4><strong>Monitoring Kontrak Operasional</strong> </h4>
                                <?php if($this->session->userdata('level_user')==1) { ?>
                                    <p align="right"><a href="<?php echo site_url('Kontrak_konsultan/add_peralatanTol') ?>"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Tambah Data</button></a></p>
                                <?php } ?>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="zero_config" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                if($dt->jenis_peralatan==1){
                                                    $jenis = 'Peralatan Tol';
                                                }elseif($dt->jenis_peralatan==2){
                                                    $jenis = 'Pemeliharaan Tol';
                                                }else{
                                                    $jenis = '';
                                                }
                                            ?>
                                            <tr>
                                                ...
                                                <td align="center"><div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        ...
                                                        <a class="dropdown-item" href="<?php echo site_url('Kontrak_konsultan/laporanPeralatan/' . $dt->id_kontrak_konsultan) ?>" >Laporan Pekerjaan &emsp;<span class="badge badge-pill badge-primary"><?php echo $jml_lap ?></span></a>
                                                        ...
                                                        <a class="dropdown-item" href="<?php echo site_url('Kontrak_konsultan/update_peralatanTol/' . $dt->id_kontrak_konsultan) ?>">Edit</a>
                                                        <a class="dropdown-item" href="<?php echo site_url('Kontrak_konsultan/hapus_peralatanTol/' . $dt->id_kontrak_konsultan) ?>" onClick="javasciprt: return confirm('Yakin menghapus data ?')">Hapus</a>
                                                    </div>
                                                </div> <br>
...
<div class="modal fade" id="addAddendumKonsultan" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style="max-width: 700px">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo site_url('Kontrak_konsultan/act_add_Addendum/3') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
