                            ...
                            <div class="card-body">
                                ...
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control show-tick ms select2" id="jenis_lap" name="jenis_lap" data-parsley-required="true" onchange="status_change(this.value)">
                                                ...
                                                <option <?php if ($jenis_lap == 'Mingguan') { echo 'selected'; }?> value="Mingguan">Mingguan</option>
                                                ...
                                                <option <?php if ($jenis_lap == 'As Built Drawing') { echo 'selected'; }?> value="As Built Drawing">As Built Drawing</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text"  name="box" class="form-control" value="<?php echo $no_box ?>" placeholder="Baris No.">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="browse-wrap">
                                                <a href="<?php echo base_url("file_uploads/laporan_konstruksi/$dok_file")?>" target="_blank" class="btn btn-success btn-sm " >&emsp;<i class="fa fa-print"></i>&nbsp; Preview &emsp;</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
