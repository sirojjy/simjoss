                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body border-bottom">
                                <h4><strong>Monitoring Kontrak Konsultan non Tol</strong> </h4>
                                <?php if($this->session->userdata('level_user')==1) { ?>
                                    <p align="right"><a href="<?php echo site_url('Kontrak_konsultan/add_kontrakNonTol') ?>"><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp; Tambah Data</button></a></p>
                                <?php } ?>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="table2" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                        <thead>
                                            <tr style="text-align: center; background-color: #98D4FF">
                                                ...
                                                <th>Tahun</th>
                                                <th>Jenis</th>
                                                <th style="width: 380px;">Nama Kontrak</th>
                                                <!-- <th>Nomor Kontrak</th> -->
                                                <th>Vendor</th>
                                                <th>Nilai Awal <br> (Rp.)</th>
                                                <th>Nilai Addendum (Rp.)</th>
                                                <!-- <th style="width: 90px;">Tanggal Berakhir</th> -->
                                                <th>Addendum</th>
                                                <!-- <th>Pembayaran</th> -->
                                                <?php if($this->session->userdata('level_user')==1) { ?>
                                                    <th>Detail</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                if($dt->jenis_konsultannontol==1){
                                                    $jenis = 'Kontrak Akibat Pembebasan Lahan';
                                                }elseif($dt->jenis_konsultannontol==2){
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><div class="dropdown">
                                                    <button class="btn btn-primary btn-sm dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="ti-pencil"></i>&nbsp; View Detail</button>
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        ...
                                                        <a class="dropdown-item" href="<?php echo site_url('Kontrak_konsultan/laporanNonTol/' . $dt->id_kontrak_konsultan) ?>" >Laporan Pekerjaan &emsp;<span class="badge badge-pill badge-primary"><?php echo $jml_lap ?></span></a>
                                                        ...
                                                        <a class="dropdown-item" href="<?php echo site_url('Kontrak_konsultan/update_kontrakNonTol/' . $dt->id_kontrak_konsultan) ?>">Edit</a>
                                                        <a class="dropdown-item" href="<?php echo site_url('Kontrak_konsultan/hapus_kontrakNonTol/' . $dt->id_kontrak_konsultan) ?>" onClick="javasciprt: return confirm('Yakin menghapus data ?')">Hapus</a>
                                                    </div>
                                                </div> <br>
...
<div class="modal fade" id="addAddendumKonsultan" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style="max-width: 700px">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo site_url('Kontrak_konsultan/act_add_Addendum/2') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
