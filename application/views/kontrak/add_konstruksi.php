                    ...
                    <form class="form-horizontal" action="<?php echo $action ?>" enctype="multipart/form-data" data-parsley-validate="true" method="post">
                        <div class="border p-4 rounded">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary "> <b>Tambah Data Kontrak Konstruksi</b></h5>
                            </div>
                            <hr />
                            ...
                            <div class="row mb-3">
                                <label for="inputPhoneNo2" class="col-sm-3 col-form-label">Paket</label>
                                <div class="col-sm-9">
                                    <input type="text" required="" name="seksi" class="form-control">
                                </div>
                            </div>
                            <div class="row mb-3">
