            ...
            <div class="container-fluid">            
                <div class="row clearfix">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="header">
                                <h2><strong>Monitoring Kontrak</strong> </h2>
                                <p align="right"><a href="<?php echo site_url('Kontrak/add_kontrak') ?>"><button type="button" class="btn btn-primary">Tambah Data</button></a></p>
                            </div>
                            <div class="body">
