...
<div class="modal fade" id="addRowModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style="max-width: 700px">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo site_url('Kontrak/act_UploadPembayaranNonTol_edit') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
...
<div class="modal fade" id="updateDok" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style="max-width: 700px">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo site_url('Kontrak/act_dokPembayaranNonTol_edit') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                <div class="modal-body" style="padding: 2.2rem">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#updateDok').on('show.bs.modal', function(e) { 
                ...
                var link = "<?= base_url()?>";
                var evidence ='<a href="'+link+"file_uploads/konstruksi_nonTol/dokumen_pembayaran/"+file+'" target="_blank" class="btn btn-success btn-sm btn-block"><i class="ti ti-printer"></i> Preview Dokumen</a>';
