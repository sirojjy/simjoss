                            ...
                            <div class="card-body">
                                ...
                                <div class="border p-4 rounded">
                                    <div class="card-title d-flex align-items-center">
                                        ...
                                        <h5 class="mb-0 text-primary "> <b>Update Data Kontrak Konstruksi non Tol</b></h5>
                                    </div>
                                    <hr/>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control show-tick ms select2" required="" name="jenis" data-placeholder="Select">
                                                    ...
                                                    <option <?php if ($jenis == '1') { echo 'selected'; }?> value="1" >Kontrak Akibat Pembebasan Lahan</option>
                                                    <option <?php if ($jenis == '2') { echo 'selected'; }?> value="2" >Kontrak Akibat Pembangunan Tol/Pelengkap Tol</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" required="" name="nomor_kontrak" value="<?php echo $nomor_kontrak ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="inputPhoneNo2" class="col-sm-3 col-form-label">Tanggal Kontrak</label>
                                        <div class="col-sm-9">
                                            <input type="date" required="" name="tanggal_awal" value="<?php echo $tanggal_mulai ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="inputPhoneNo2" class="col-sm-3 col-form-label">Tanggal Berakhir</label>
                                        <div class="col-sm-9">
                                            <input type="date" required="" name="tanggal_akhir" value="<?php echo $tanggal_akhir ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="inputPhoneNo2" class="col-sm-3 col-form-label">Lokasi Pekerjaan</label>
                                        <div class="col-sm-9">
                                            <textarea class="form-control" name="lokasi" rows="3"><?php echo $lokasi ?></textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="inputPhoneNo2" class="col-sm-3 col-form-label">Pihak Pertama</label>
                                        <div class="col-sm-9">
                                            <input type="text" required="" name="pihak1" value="<?php echo $pihak_pertama ?>" class="form-control" value="PT Trans Jawa Paspro Jalan Tol">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="inputPhoneNo2" class="col-sm-3 col-form-label">Pihak Kedua</label>
                                        <div class="col-sm-9">
                                            <input type="text" required="" name="pihak2" value="<?php echo $pihak_kedua ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
